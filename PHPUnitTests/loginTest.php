...
final class loginTest extends TestCase {
  public function testloginUser() {
      ...
      $this->assertEquals('{"data":"Username taken, try again!"}',loginUser('Bobby', 'moiMoir3', 'moiMoir3', 'trololo@trol.com',null, null, null));
      $this->assertEquals('{"data":"Nope, wrong username or password!"}',loginUser('Fake', 'moiMoir3', 'moiMoir3', null, null, null, null));
  }
