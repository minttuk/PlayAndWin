...
final class loginTest extends TestCase {
  public function testloginUser() {
      ...
      $this->assertEquals('{"data":"Username taken, try again!"}',loginUser('Bobby', 'moiMoir3', 'moiMoir3', 'trololo@trol.com',null, null, '10.10.1950'));
      $this->assertEquals('{"data":"Nope, wrong username or password!"}',loginUser('Fake', 'moiMoir3', 'moiMoir3', null, null, null, '10.10.1950'));
  }
  public function testregUser() {
      $this->assertInternalType('int', regUser('Fake', 'moiMoir3', 'moiMoir3', 'testi@testi.com', 'Php', 'UnitTest', '10.10.1950'));
  }
